...
public class Channel2 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		for (int i = 1; i <= clients; i++) {
			...
			client.start();
			Thread.sleep(1); // Delay before starting new client connection
								// (protection for non-blocking clients)
		}
	}
}
...
class TCPSocketChannel extends Thread {
	...
	/**
	 * Constructor method responsible for initializing the function and Inet
	 * location of the thread.
	 * 
	 * @param address
	 *            String responsible for the universal destination/source of the
	 *            client/server.
	 * @param port
	 *            The port the client will connect to, or the server will host
	 *            on.
	 * @param function
	 *            Enum type identifying whether the thread is acting as a client
	 *            or server.
	 * @throws IOException
	 */
	...
	/**
	 * Thread extended method responsible for consistently checking for
	 * satisfied keys.
	 */
	public void run() {
		while (true) {
	...
	/**
	 * Public call supposed to tie into registering an object to satisfy
	 * key.isConnectable.
	 * 
	 * @param socket
	 * @throws IOException
